...
## How to build
Building this library for the target platform requires proprietary cross-compilation toolchains and run on a specific host machine, along with some other proprietary tools. This is not included here.
