...
## Why?
A need for a simple standalone IETF RFC 4880 signature verifier prompted this. It wasn't clear how out of date [NetPGP](https://netpgp.com/) might be, and there was a problem with the "portable" build needing OpenSSL installed to the build device. We are building on a cross-compiler and plan to build on a "Canadian Cross" system eventually. This means a full autoconf build or a simple self-hosted solution. We chose the latter.
